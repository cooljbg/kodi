...
addons_url_list = [
    ...
    "https://github.com/bokobokoboko/plugin.video.mytvbg/archive/master.zip",
    "https://github.com/mrolix/plugin.video.neterratv/archive/master.zip",
    "https://github.com/steeve/plugin.video.pulsar/releases/download/v0.5.0/plugin.video.pulsar-0.5.0.zip",
    ...
    "https://github.com/enen92/service.sleeptimer/archive/master.zip",
    "https://www.andromeda.eu.org/xbmc/plugin.video.brigada-0.1.0.zip",
    "https://www.andromeda.eu.org/xbmc/plugin.video.nova.play-0.1.1.zip",
    "https://www.andromeda.eu.org/xbmc/plugin.video.vbox7-0.3.6.zip",
  ]
